...
//config.db holds Orchestrate token
...
exports.localReg = function (username, password) {
    ...
    var user = {
        "username": username, "password": hash, "avatar": "http://placepuppy.it/images/homepage/Beagle_puppy_6_weeks.JPG"
    }


    //Check for username availability
    db.get('local-users', username).then(function (result) { //case in which user already exists in db 
...
exports.localAuth = function (username, password) {
    ...
    db.get('local-users', username).then(function (result) {
        ...
        var hash = result.body.password; console.log(hash);
